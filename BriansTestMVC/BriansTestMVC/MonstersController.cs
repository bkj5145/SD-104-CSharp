...
namespace BriansTestMVC
{
    public class MonstersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,MonsterName,Lvl,AttackPower,CurrentExp,Alive,Health")] Monster monster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MonsterName,Lvl,AttackPower,CurrentExp,Alive,Health")] Monster monster)
        {
            if (ModelState.IsValid)
            {
